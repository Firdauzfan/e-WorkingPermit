...
if (isset($_POST["carii"]))  {
	 $cari = $_POST["carii"];	 
	 $query_Recordset1 ="SELECT * FROM tb_user where (no_id like '%$cari%' or nama like '%$cari%')  and bagian = 'Departement' and no_id != '12078215' ORDER BY `no` DESC ";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_Recordset1, $konek) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);		 
$query_jml = "SELECT count(*) as num FROM tb_user where (no_id like '%$cari%' or nama like '%$cari%') and bagian = 'Departement' and no_id != '12078215' ORDER BY `no` DESC ";
}
	 else{		
$query_Recordset1 ="SELECT * FROM tb_user where bagian = 'Departement' and no_id != '12078215' ORDER BY `no` DESC ";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $konek) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);			 
$query_jml = "SELECT count(*) as num FROM tb_user where bagian = 'Departement' and no_id != '12078215'";
		 }
...
<form id="form1" name="form1" method="post" action="user_list_dept.php">
    ...
    <tr>
      <td><table width="100%" >
        <tr>
          <td><table width="100%" cellspacing="0" cellpadding="0">
            <tr>
              <td nowrap="nowrap" class="judul">Departement Incharge List</td>
	  ...
	  do { ?>
		  ...
		  $email = $row_Recordset1['email'];?>
              ...
              <tr class="isi">
                <td colspan="10" align="right"><?php if (!isset($_POST["carii"]))  { include ('paging.php');} ?></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
