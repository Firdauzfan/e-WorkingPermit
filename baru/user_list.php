...
if (isset($_POST["carii"]))  {
	 $cari = $_POST["carii"];	 
	 $query_Recordset1 ="SELECT * FROM tb_user where (no_id like '%$cari%' or nama like '%$cari%')  and bagian != 'Departement' and no_id != '12078212' and no_id != '12078213' and no_id != '12078215' ORDER BY `bagian` ASC ";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $konek) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);		 
$query_jml = "SELECT count(*) as num FROM tb_user where (no_id like '%$cari%' or nama like '%$cari%') and bagian != 'Departement' and no_id != '12078212' and no_id != '12078213' and no_id != '12078215' ORDER BY `bagian` ASC ";
}
	 else{		
$query_Recordset1 ="SELECT * FROM tb_user where bagian != 'Departement' and no_id != '12078212' and no_id != '12078213' and no_id != '12078215' ORDER BY `bagian` ASC";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $konek) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);			 
$query_jml = "SELECT count(*) as num FROM tb_user where bagian != 'Departement' and no_id != '12078212' and no_id != '12078213' and no_id != '12078215' ORDER BY `bagian` ASC";
		 }
...
<form id="form1" name="form1" method="post" action="user_list.php">
  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <tr>
          <td><table width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td align="right" nowrap="nowrap"><span id="sprytextfield1">
                <label>
                  <input type="text" name="carii" id="carii" value = <?php echo $cari;?>>
                </label>
               </span>
                <label>                 
	  ...
	  do { ?>
		  ...
		  $email = $row_Recordset1['email'];?>
              <tr class="isi" height="20" >
                <td align="center"><span class="isi1">
                  <?php if($jml_row > 0 ){ echo  $nomer; }?>
                </span></td>
              ...
              <tr class="isi">
              <td colspan="10" align="right">&nbsp;<?php  include ('paging.php'); ?></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
    ...
    <tr>
      <td height="18" colspan="2" align="center"><?php include("foot.php"); ?></td>
    </tr>
  </table>
  <p class="isi">&nbsp;</p>
</form>
